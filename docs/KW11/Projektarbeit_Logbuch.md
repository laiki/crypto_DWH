...
- Datensammlung über Nacht starten 
  Die vergangenen 2 Wochen haben gezeigt, dass 
    a) **ein lokaler Prozess aus dem Heimnetzwerk nicht sinnvoll möglich ist da der Internetprovider nachts kurzfristig die Verbindung neu aufbaut. (IP-reset)**
   Prozesse die kontinuierlich Daten über Internet-Socketverbindungen wie Web-Sockets, RestAPIs empfangen, werden dadurch unterbrochen.
    ...
    b) **Eine sehr hohe Menge an Daten zusammengetragen wird.**
...
- Umsetzungsplan der nächsten Tage dokumentieren
  ...
  - Tag 2:
    ...
    - [ ] ML forecast Modelle trainieren
...
1 directory, 28 files
    ...
    - Marts: Erzeuge und fülle "dash_cache_*" Tabellen mit Daten der Viewsfür schnellen Zugriff aus dem Dashboard
        ...
        ** OLAPs:
        ** vw_mart_dashboard_platform_quality_daily und vw_mart_dashboard_platform_quality_hourly: Latenz & Disconnectcount pro Exchange 
        ** vw_mart_dashboard_price_deviation_daily und vw_mart_dashboard_price_deviation_hourly: Max/Min Preisabweichung pro Symbol-Exchange Paar
        ** vw_mart_dashboard_symbol_deviation_bucket: Liste der Symbole pro Exchange
        ** vw_mart_dashboard_symbol_observed_quality_base: Liste der Symbole pro Exchange mit Qualitätsangebe bzgl fehlender oder interpolierter Daten
        ** vw_mart_latest_cleansing_run: Info zu cleansing run
        ** vw_mart_dashboard_price_curve_24h_binance: Preisinfo von Symbolen aus Binance zum Vergleich mit anderen Plattformen
